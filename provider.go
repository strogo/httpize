...
// Add function to be handled. p: is a pattern to be handled. Patterns are like
...
// [path/]name?arg_word1=...&arg_word2=... etc. c is a Caller interface that
// will be called to when pattern is matches for a HTTP request. It will be
...
// Add type to be used in parameters of exported methods. t: name of type
// to export, to be used in Export(). f: a function to create a new instance
